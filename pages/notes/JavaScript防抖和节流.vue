  ...
  <b-container fluid class="bv-example-row content">
    <b-row>
      ...
      <b-col sm="12" md="8" lg="8" xl="6">
        ...
        <p>测试结果如下：</p>
        <br />
        <span>当我快速输入macbook时，只会发送一次请求</span>
        ...
        <i>我们可以根据是否传入leading进行不同的处理方式</i>
        ...
        <ul>
          <li>
            因为没有达到最终的时间，也就是条
            <span class="txt-color-deeppink">now - last > interval</span> 件满足不了的
          </li>
